			...
			case SHRUB_OK:
				{
					...
					{
						plant = vit->second;
						snprintf ( classname,127,"%s.%s",TileClassNames[tileTypeTable[tiletype].shape],plant );
					}
					else
					{
...
int convertMaps ( DFHack::Core *DF,DFHack::Materials * Mats )
{
	...
	{
		DFConsole->print ( "WARNING: maps larger than 512x512x128 can cause issues with Minecraft indev\n" );
	}
